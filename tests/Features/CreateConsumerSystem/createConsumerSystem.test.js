...
describe("Creates a consumer system (020)", () => {
  let driver;
  ...
  it("Create a consumer system works", async () => {
    ...
    const clintIdSelectIsStaleness = await driver.wait(
      until.stalenessOf(clientIdSelect),
      5 * 1000
    );

    expect(clintIdSelectIsStaleness).toBe(true);
    ...
    expect(systemClassOfCreated).toBe("consumer");
  });
